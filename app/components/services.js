            ...
            <div className="container">
                <div className="flex gap-10">
                    ...
                    <div className="w-1/2">
                        ...
                        <p className="text-gray-600">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                        ...
                        <div className="flex gap-5 mb-5">
                            <div className="w-1/2 ">
                                ...
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Debitis ducimus suscipit libero!</p>
                            </div>
                            <div className="w-1/2">
                                <div className='text-4xl text-blue-500 mt-6'>
                                    <BsChatLeftDots />
